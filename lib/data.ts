...
export const locations: Location[] = [
  ...
  {
    id: "berri-uqam-metro",
    name: "Berri-UQAM Métro",
    address: "1500 Rue Berri",
    city: "Montréal, QC",
  ...
  {
    id: "u-calgary-active-living",
    name: "U of Calgary — Active Living Centre",
  ...
  {
    id: "kanata-north-tech",
    name: "Kanata North Tech Hub",
    address: "555 Legget Drive",
    city: "Ottawa, ON",

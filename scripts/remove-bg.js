...
const SRC = "public/nutrivendo-smart-machine.jpeg";
const OUT = "public/nutrivendo-smart-machine.png";

// Pixels brighter than this (and low saturation) are candidate background.
const WHITE_MIN = 235; // start of the soft edge ramp
const WHITE_FULL = 248; // fully-background above this
...
(async () => {
  ...
  // Apply alpha: background -> 0. Soft ramp on machine edges that border bg.
  let cleared = 0;
  for (let p = 0; p < w * h; p++) {
    const i = p * channels;
    if (bg[p]) {
